...
import { instruction } from '../utils/internationalisation';
			...
			<View style={{flex:1, backgroundColor:'#eee'}}>
				<View style={Css.header_main}>
					...
					<View style = {Css.header_main_text_view}>
						<Text style ={Css.header_main_text}>{instruction.headerTitle}</Text>
					</View>
				</View>
				<WebView 
          			source = {{ uri : 'http://mygreenpurse.com/instructions/'}} 
