...
import { segregationTips } from '../utils/internationalisation';

export default class SegregationTips extends Component {

	static navigationOptions = {
   		 header: false,
       drawerLabel: "Segregation Tips",
 	 	};
			...
			<View style={{flex:1, backgroundColor:'#eee'}}>
				<View style={Css.header_main}>
					...
					<View style = {Css.header_main_text_view}>
						<Text style ={Css.header_main_text}>{segregationTips.headerTitle}</Text>
					</View>
				</View>
      			<WebView 
          			source = {{ uri : 'http://mygreenpurse.com/tips/'}} 
